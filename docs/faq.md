...
A profile readme appears on your profile page when you create a repository with the same name as your username and add a `README.md` file to it. For example, the repository for the user [`Venky Kumar`](https://github.com/BoddepallyVenkatesh06) is located at [`Venky Kumar/Venky Kumar`](https://github.com/BoddepallyVenkatesh06/BoddepallyVenkatesh06).
...
```html
<a href="https://readme-streak-stats-venky-kumar.netlify.app/"><img src="https://readme-streak-stats-venky-kumar.netlify.app/"/></a>
```
<!-- prettier-ignore-end -->
...
```html
<picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://readme-streak-stats-venky-kumar.netlify.app/&theme=dark" />
    <img src="https://readme-streak-stats-venky-kumar.netlify.app/&theme=default" />
</picture>
```
<!-- prettier-ignore-end -->
